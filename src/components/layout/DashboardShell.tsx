...
const corporateNav: NavItem[] = [
  ...
  { href: '/business/dashboard/employees', label: 'Employees', icon: '👥' },
  { href: '/business/dashboard/invite', label: 'Invite', icon: '✉️' },
  { href: '/business/dashboard/analytics', label: 'Analytics', icon: '📈' },
  { href: '/business/dashboard/billing', label: 'Billing', icon: '💳' },
  { href: '/business/dashboard/challenges', label: 'Challenges', icon: '🏆' },
  { href: '/business/dashboard/settings', label: 'Settings', icon: '⚙️' },
];

const partnerNav: NavItem[] = [
  { href: '/partners/dashboard', label: 'Overview', icon: '📊' },
  { href: '/partners/dashboard/listing', label: 'Listing', icon: '📝' },
  { href: '/partners/dashboard/reviews', label: 'Reviews', icon: '⭐' },
  { href: '/partners/dashboard/leads', label: 'Leads', icon: '🎯' },
  { href: '/partners/dashboard/promotions', label: 'Promotions', icon: '📣' },
  { href: '/partners/dashboard/analytics', label: 'Analytics', icon: '📈' },
  { href: '/partners/dashboard/corporate', label: 'Corporate', icon: '🏢' },
];
