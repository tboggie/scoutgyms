...
export default function EarningsPage() {
 ...
 <div className="flex items-center gap-3"><div className="w-10 h-10 rounded-lg bg-blue-light flex items-center justify-center text-blue text-lg">BANK</div><div><p className="text-sm font-medium">Bank account ••4892</p><p className="text-xs text-text3">Payouts every Friday</p></div></div>
