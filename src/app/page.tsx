      ...
      <section className="py-20" id="features">
        <div className="max-w-[1140px] mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[{i:'📍',t:'Zip code search',d:'Find every gym near any US zip code with adjustable radius from 1 to 25 miles.',bg:'bg-teal-light',tc:'text-teal'},
              {i:'⚖️',t:'Side-by-side comparison',d:'Compare up to 3 gyms across 15+ data points including cost, equipment and classes.',bg:'bg-blue-light',tc:'text-blue'},
              ...
              {i:'⭐',t:'Verified reviews',d:'Only members who have actually visited can leave reviews. No fake reviews.',bg:'bg-amber-light',tc:'text-amber'},
              {i:'📷',t:'Member photos',d:'See real photos uploaded by actual gym members, not polished marketing shots.',bg:'bg-purple-light',tc:'text-purple'},
              {i:'⏰',t:'Peak hours data',d:'See when each gym is busiest so you can plan your visit around quieter times.',bg:'bg-coral-light',tc:'text-coral'},
              {i:'❤️',t:'Smart match quiz',d:'Answer 5 quick questions. We rank gyms by how well they fit your needs.',bg:'bg-red-light',tc:'text-red'},
              {i:'🔔',t:'Price drop alerts',d:'Get notified when gyms run promotions, drop prices or waive joining fees.',bg:'bg-teal-light',tc:'text-teal'},
              {i:'🏃',t:'Trial pass booking',d:'Book a free or discounted trial session directly through the app.',bg:'bg-blue-light',tc:'text-blue'}
            ].map(f=>(
