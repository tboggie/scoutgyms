...
export default function BusinessHowItWorks() {
 ...
 <div className="bg-card rounded-2xl border border-border p-8 shadow-lg flex items-center justify-center h-64 text-4xl font-[var(--font-display)] font-extrabold text-teal">Step {String(i+1)}</div>
 </div>
 </div>
 </section>
 ))}
