      ...
      <section className="py-20 bg-bg2">
        <div className="max-w-[1140px] mx-auto px-6">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-5">
            {[{i:'🌐',t:'Full gym network access',d:'28,000+ gyms from budget chains to boutique studios.',bg:'bg-teal-light'},{i:'📊',t:'Real-time HR dashboard',d:'Utilisation by office, cost per employee, engagement trends.',bg:'bg-blue-light'},{i:'🧾',t:'Single consolidated invoice',d:'One invoice per month covers every employee across every gym.',bg:'bg-green-light'},{i:'👤',t:'Self-serve employee portal',d:'Employees search, compare and join gyms on their own.',bg:'bg-purple-light'},{i:'🔐',t:'SSO and HRIS integration',d:'Connect with Okta, Azure AD, BambooHR, Workday and more.',bg:'bg-amber-light'},{i:'🏆',t:'Wellness challenges',d:'Run company-wide fitness challenges with leaderboards.',bg:'bg-coral-light'}].map(f=>(
