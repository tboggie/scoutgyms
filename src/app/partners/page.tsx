...
export default function PartnersPage() {
 ...
 {[{i:'CL',t:'Claim your listing',d:'Your gym may already be listed. Claim it, add photos, update pricing and respond to reviews.',bg:'bg-teal-light'},{i:'D',t:'Analytics dashboard',d:'See who is viewing and comparing your gym, and where you are winning or losing.',bg:'bg-blue-light'},{i:'P',t:'Pay per result',d:'No monthly fees. You only pay a commission when someone signs up through ScoutGyms.',bg:'bg-green-light'},{i:'PR',t:'Promote offers',d:'Run limited-time promotions that appear highlighted to nearby searchers.',bg:'bg-amber-light'},{i:'RE',t:'Respond to reviews',d:'Reply to member reviews publicly. Show potential members you care.',bg:'bg-purple-light'},{i:'W',t:'Earn badges',d:'Hit quality benchmarks and earn trust badges that show on your listing.',bg:'bg-coral-light'}].map(f=>(
