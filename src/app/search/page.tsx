...
const thumbs = ['/gym-photos/weights.jpg','/gym-photos/fitlife-1.jpg','/gym-photos/peak-1.jpg','/gym-photos/training.jpg','/gym-photos/pool.jpg','/gym-photos/machines.jpg','/gym-photos/gym-7.jpg','/gym-photos/gym-8.jpg','/gym-photos/gym-9.jpg','/gym-photos/gym-10.jpg','/gym-photos/gym-11.jpg','/gym-photos/gym-12.jpg','/gym-photos/gym-13.jpg','/gym-photos/gym-14.jpg','/gym-photos/cardio.jpg','/gym-photos/interior.jpg','/gym-photos/boxing.jpg','/gym-photos/class.jpg','/gym-photos/fitlife-3.jpg','/gym-photos/peak-3.jpg'];
          ...
          {results.map(gym=>(
            <div key={gym.id} className="bg-card rounded-2xl border border-border p-5 hover:shadow-lg transition-all">
              <div className="flex flex-col md:flex-row md:items-center gap-4">
                <img src={thumbs[(parseInt(gym.id)-1) % thumbs.length]} alt={gym.name} className="w-full md:w-28 h-20 rounded-xl object-cover flex-shrink-0"/>
